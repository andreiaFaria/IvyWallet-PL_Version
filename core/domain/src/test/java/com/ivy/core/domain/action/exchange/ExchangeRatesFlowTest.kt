...
//@ExtendWith(MainCoroutineExtension::class) // this is replaced by the companion object
class ExchangeRatesFlowTest{
    ...
    } // we need to do this because the MainCoroutineExtension is also creating a StandardTestDispatcher
    ...
    fun `Test exchange rates flow emissions`() = runTest {
        ...
        val exchangeRateOverrides = listOf(
            exchangeRateOverrideEntity(currency = "CAD", rate = 1.5)
