...
fun exchangeRateEntity( currency: String, rate: Double): ExchangeRateEntity {
...
fun exchangeRateOverrideEntity(currency: String, rate: Double): ExchangeRateOverrideEntity{
